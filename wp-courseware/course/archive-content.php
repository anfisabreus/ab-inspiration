...
do_action( 'wpcw_course_before_archive_content' ); ?>
	<div class="wpcw-course-archive-content">
      ...
      <a href="<?php echo the_permalink();?>"> <?php echo wpcw_get_course_thumbnail(); ?></a>
     <a href="<?php echo the_permalink();?>"><h2 class="entry-title entry-title-single"><?php echo wpcw_get_course_title(); ?></h2>  </a>
