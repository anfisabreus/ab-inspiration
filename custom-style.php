...
.cbp-l-caption-buttonLeft:hover, .cbp-m-caption-buttonLeft:hover, .cbp-s-caption-buttonLeft:hover, div.post-font a.more-link:hover, .search-button:hover, .submit:hover, a.comment-reply-link:hover, #submit:hover, .submit:hover, .button-form:hover, #content div.post-font a.more-link:hover, .pagenavi a:hover, .pagenavi span.current:hover,#searchsubmit:hover, #content .woocommerce a.button:hover, .woocommerce a.button:hover,  #content .woocommerce button.button:hover,  #content .woocommerce input.button:hover, .buton-unit:hover, #content .wpcw_fe_quiz_submit_data input.fe_btn_completion:hover, #content .wpcw-course-enrollment-button a.fe_btn_completion:hover, .wpcw-button.wpcw-button-primary:hover, .tml-button:hover{ '; if ( of_get_option('button_color_hover') !== '') { $css .= 'background-color:'. of_get_option('button_color_hover').' !important;';} else { $css .= 'background-color:transparent !important;';} 
if ( of_get_option('button_color_text_hover') !== '') { $css .= 'color:'. of_get_option('button_color_text_hover').' !important;';} else { $css .= 'color:#000 !important;';} $css .= '}
...
#primary .widget-title {'; if (of_get_option('widget_header_bg') == '') { $css .= 'padding:5px 0px 25px 0px !important;';} else { $css .= 'padding: 5px 5px 5px 10px;';}  if (of_get_option('widget_header_align') == 'center') { $css .= 'text-align:center;';} else { $css .= 'text-align:left;';} $css .= '}
...
#subs .sp-form { padding:0px !important; '; if (of_get_option('form_uploader_transparent') == '1' ) { $css .= 'width:258px !important'; }  else { $css .= 'width:258px !important;';} $css .= '}
