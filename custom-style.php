...
$scrollupbuttoncolor   = of_get_option('button_color');
$scrolluphex = hex2rgba($scrollupbuttoncolor, '0.7');

$scrollupbuttoncolorh   = of_get_option('button_color_hover');
$scrolluphexhover = hex2rgba($scrollupbuttoncolorh, '0.7');
...
$color_one_rgbaul_scroll = hex2rgba($color_one, '0.7');
$color_one_rgbaul_scroll_h = hex2rgba($color_one, '0.9');
...
if (of_get_option('headings_fonts_headers') == 'Neucha') { $css .= '@import url(//fonts.googleapis.com/css2?family=Neucha&subset=cyrillic&display=swap);';} 
if (of_get_option('headings_fonts_headers') == 'Lobster') { $css .= '@import url(//fonts.googleapis.com/css2?family=Lobster&subset=cyrillic&display=swap);';} 
if (of_get_option('headings_fonts_headers') == 'Comfortaa') { $css .= '@import url(//fonts.googleapis.com/css2?family=Comfortaa&subset=cyrillic&display=swap);';} 
if (of_get_option('headings_fonts_headers') == 'Didact Gothic') { $css .= '@import url(//fonts.googleapis.com/css2?family=Didact+Gothic&subset=cyrillic&display=swap);';} 
if (of_get_option('headings_fonts_headers') == 'Montserrat' || of_get_option('headings_fonts_text') == 'Montserrat') { $css .= '@import url(//fonts.googleapis.com/css2?family=Montserrat:wght@100;200;300;400;500;600;700&display=swap);';} 

if (of_get_option('headings_fonts_headers') == 'Oswald' || of_get_option('headings_fonts_text') == 'Oswald') { $css .= '@import url(//fonts.googleapis.com/css2?family=Oswald:wght@200;300;400;500;600;700&display=swap);';} 
...
#access .menu-header ul, div.menu ul {'; if (of_get_option('menu_position_horizontal') == '1') { $css .= '';} elseif (of_get_option('menu_position_horizontal') == '2') { $css .= 'display: table;float: right;';} else { $css .= 'display: table;float: left;  width:100%';}
$css .= '}
...
';if ( of_get_option('menu_text_hover') !== '') { $css .= 'color:'. of_get_option('menu_text_hover').';';} else { $css .= 'color:#000;';} $css .= '}
...
#access li a, #access li.cart-in-menu.current-menu-item a {text-decoration: none;'; $typography = of_get_option('menu_typography'); if ($typography) { if ( $typography['color'] !== '') { $css .= 'color:'. $typography['color'];} else { $css .= 'color:#000';}  $css .= ';
...
#access a:hover {';if ( of_get_option('menu_text_hover') !== '') { $css .= 'color:'. of_get_option('menu_text_hover').' ;';} else { $css .= 'color:#000 ;';} $css .= '}
...
.woocommerce a.button, .woocommerce #respond input#submit,  .woocommerce button.button, .woocommerce input.button { '; if ( of_get_option('button_color') !== '') { $css .= 'background:'. of_get_option('button_color').' ;';} 
else { $css .= 'background:transparent ;';} 
if ( of_get_option('button_color_text') !== '') { $css .= 'color:'. of_get_option('button_color_text').' ;';} else { $css .= 'color:#000 ;';} $css .= '-webkit-transition: all 0.5s;transition: all 0.5s;}
...
#content ul.commentstabs li.commentab a.active, .author-tabs {border:1px solid '; if ( of_get_option('button_color') !== '') { $css .= of_get_option('button_color');} else { $css .= 'transparent';} $css .= '!important;}
...
{'; if ( of_get_option('button_color') !== '') { $css .= 'background-color:'. of_get_option('button_color').' ;';} else { $css .= 'background-color:transparent ;';} 
if ( of_get_option('button_color_text') !== '') { $css .= 'color:'. of_get_option('button_color_text').' ;';} else { $css .= 'color:#000 ;';} $css .= '}

.scrollupinsight {'; if ( of_get_option('button_color') !== '') { $css .= 'background-color:'. $scrolluphex .' !important;';} else { $css .= 'background-color:transparent !important;';} 
if ( of_get_option('button_color_text') !== '') { $css .= 'color:'. of_get_option('button_color_text').' !important;';} else { $css .= 'color:#000 !important;';} $css .= '}

.scrollupinsight:hover { '; if ( of_get_option('button_color_hover') !== '') { $css .= 'background-color:'. $scrolluphexhover .' !important;';} else { $css .= 'background-color:transparent !important;';} 
...
ul.commentstabs li.commentab a:hover {border:1px solid #eee; background:#fff; '; if ( of_get_option('button_color') !== '') { $css .= 'color:'. of_get_option('button_color').' !important;';} else { $css .= 'color:#000 !important;';} $css .= '}
...
{'; if ( of_get_option('buttons_shape') == '3px'){ $css .= 'border-radius: 3px; -moz-border-radius: 3px;-webkit-border-radius: 3px;';} else {$css .= 'border-radius: 0px; -moz-border-radius: 0px;-webkit-border-radius: 0px;';}  $css .= '}
...
#footer a {'; if ( of_get_option('footer_color') !== '') { $css .= 'color:'. of_get_option('footer_color').' ;';} else { $css .= 'color:#000;';} $css .= '}
...
#footer-widget-area  a:link, #footer-widget-area  a:visited {text-decoration: none; '; if ( of_get_option('widget_footer_color') !== '') { $css .= 'color:'. of_get_option('widget_footer_color').';';} else { $css .= 'color:#000;';} $css .= '}
#footer-widget-area  a:active, #footer-widget-area  a:hover, #footer-widget-area ul li.widget a:hover {background:none;text-decoration: underline; '; if ( of_get_option('widget_footer_color') !== '') { $css .= 'color:'. of_get_option('widget_footer_color').';';} else { $css .= 'color:#000;';} $css .= '}
...
$css .= '} .widget-area a:link, .widget-area a:visited {text-decoration: none; } #footer-widget-area  a:link, #footer-widget-area  a:visited, #footer-widget-area{'; if ( of_get_option('widget_footer_color') !== '') { $css .= 'color:'. of_get_option('widget_footer_color').';';} else { $css .= 'color:#000;';} $css .= '}
...
{ $css .= '#main {max-width:1200px !important;} #primary {width:32% !important}#form-background{width:100% !important; margin-bottom:30px !important; }.entry-box {padding:20px;}li.widget-container, div.widget-container {margin-bottom:20px; padding:30px; } .one-column #content {width:1200px;} #container {width:66.4% !important;} #container.one-column {width:100% !important;} #content {width:100%;}.pagenavi {padding-bottom:40px}';} 
...
if (of_get_option('widget_border') == 'none') { $css .= '.widget-container:first-child {padding-top:0px !important;}#primary .widget-container:first-child .widget-title {padding-top:0px !important;}'; }
...
$css .= ' .woocommerce #content div.product div.images img, .woocommerce div.product div.images img, .woocommerce-page #content div.product div.images img, .woocommerce-page div.product div.images img, .woocommerce-Tabs-panel.woocommerce-Tabs-panel--description.panel.entry-content .contet-tab, .woocommerce div.product .woocommerce-tabs ul.tabs li {'; if ( of_get_option('post_border_color') !== '') { $css .= 'border-color:'. of_get_option('post_border_color').';';} else { $css .= 'border-color:transparent;';} $css .= '}
#primary .widget-title {'; if (of_get_option('widget_header_bg') == '') { $css .= 'padding:0px !important;';} else { $css .= 'padding: 25px 5px 5px 10px;';}  if (of_get_option('widget_header_align') == 'center') { $css .= 'text-align:center;';} else { $css .= 'text-align:left;';} $css .= '}
.woocommerce ul.products li.product, .woocommerce-page ul.products li.product, .woocommerce ul.products li.last, .woocommerce-page ul.products li.last {'; if ( of_get_option('post_border_color') !== '') { $css .= 'border-color:'. of_get_option('post_border_color').';';} else { $css .= 'border-color:transparent;';} $css .= '}


.footer-widget-box .widget-title {'; 
if ( of_get_option('footer_widget_header_bg') !== '') { $css .= 'padding: 5px 5px 5px 10px  !important;';} else { $css .= 'padding:5px 0px 25px 0px !important;';} $css .= '}
...
'; if ( of_get_option('post_headings') !== '') { $css .= 'color:'. of_get_option('post_headings').';';} else { $css .= 'color:#000;';} $css .= '}
...
.wpcw_fe_course_title {line-height:1.1 !important; text-transform: '. of_get_option('transform_widget', 'no entry' ).'; ';
$typography = of_get_option('widget_typography'); if ($typography) { if ( $typography['color'] !== '') { $css .= 'color:'. $typography['color'];} else { $css .= 'color:#000';}  $css .= ';font: '. $typography['style'] .' '. $typography['size'] .' '.  $typography['face'].';';} $css .= '}
...
if ($typography) { if ( $typography['color'] !== '') { $css .= 'color:'. $typography['color']; } else { $css .= 'color:#000';}  $css .= ' !important;font-style: '. $typography['style'] .' !important; font-weight: '; if ($homepage['heading_text_strong6'] ==  1)  {
$css .=   '500 !important';} else {$css .=   'normal !important';} $css .=  ';font-size: '. $homepage['hp_header_size6'] .'px !important;'; } $css .= '}
...
h1.entry-title-single, .wpcw_widget_progress_bar h3 { '; if ( of_get_option('title_single') !== '') { $css .= 'color:'. of_get_option('title_single').';';} else { $css .= 'color:#000;';} $css .= '}
.entry-title6 {margin-bottom:0px !important}

.entry-content a:link, .entry-content a:visited, .woocommerce div.product .stock,.widget-area a:link, .widget-area a:visited {'; if ( of_get_option('linkslink_colorpicker') !== '') { $css .= 'color:'. of_get_option('linkslink_colorpicker').';';} else { $css .= 'color:#000;';} $css .= '}
...
$menuheightplus = ((int)of_get_option('headermenu_height') + (int)of_get_option('headermenu_margin_top', 'no entry' ) + (int)of_get_option('headermenu_margin_bottom', 'no entry' ));
...
'; $typography = of_get_option('headermenu_typography'); if ($typography) { $css .= 'text-align:center; ';	if ( $typography['color'] !== '') { $css .= 'color:'. $typography['color'];} else { $css .= 'color:#000';}  $css .= ';font: '. $typography['style'] .' '. $typography['size'] .' '.  $typography['face'].';'; } $css .= 'line-height: '.$heightheademenu.'px;}
...
$css .= ' #headercssmenu a {margin:'.  of_get_option('headermenu_margin_top', 'no entry' ) .'px 3px '.  of_get_option('headermenu_margin_bottom', 'no entry' ) .'px 0px; padding: 0 15px;text-transform:'.  of_get_option('headermenu_transform', 'no entry' ) .' !important;'; $typography = of_get_option('headermenu_typography'); if ($typography) { $css .= 'text-align:center; ';if ( $typography['color'] !== '') { $css .= 'color:'. $typography['color'];} else { $css .= 'color:#000';}  $css .= '; font: '. $typography['style'] .' '. $typography['size'] .' '.  $typography['face'].';'; } $css .= '}
...
.floatmenu-ul{ position:relative; vertical-align:top; height:'. of_get_option('floatmenu_height').'px !important}
...
.inputformbutton, .sp-form input.inputformbutton, .sp-form input[type=text].inputformbutton, .sp-form input[type=email].inputformbutton{';  
if (of_get_option('form_uploader_transparent') == 1) { 
	$css .= 'width:257px;';} else { $css .= 'width:257px; margin-bottom:5px!important; ';} 
	$css .= '  font-size: 16px !important; color: #424242;   margin-bottom:5px;margin-top:3px;border:1px solid #ccc; box-shadow:none; background:#ffffff; padding-left:10px;height:38px !important; font-weight:normal !important;}
...
';if (of_get_option('form_uploader_transparent') == '1' ) { $css .= ''; }  else { $css .= 'display: grid;
...
#subs .sp-form { padding:0px !important; '; if (of_get_option('form_uploader_transparent') == '1' ) { $css .= 'width:258px !important'; }  else { $css .= '';} $css .= '}

#subs .subs-form {padding:10px;'; if (of_get_option('form_uploader_transparent') == '1' ) { $css .= 'margin: 0 auto; width: 98%; display: table;'; }  elseif (of_get_option('form_uploader_transparent') == '0' ) { $css .= 'grid-column-start: 1;
    grid-row-start: 1;';} else { $css .= '';} $css .= '}



#subs .buttonpostform, #subs .sp-form .sp-button.buttonpostform, #subs button.buttonpostform, #subs .sp-form .sp-button{'; if (of_get_option('form_uploader_transparent') == 1) {  $css .= 'width:auto;height:38px; position:relative; top:2px;';} else { $css .= 'width:258px !important; height:45px;';} 
...
h1, .wpcw-course-desc h1 {font-size:'. of_get_option('heading1').'}h2,  .wpcw-course-desc h2{font-size:'. of_get_option('heading2').'}h3,  .wpcw-course-desc h3{font-size:'. of_get_option('heading3').'}h4,  .wpcw-course-desc h4{font-size:'. of_get_option('heading4').'}h5, .wpcw-course-desc h5{font-size:'. of_get_option('heading5').'}h6, .wpcw-course-desc h6{font-size:'. of_get_option('heading6').'}
...
if (function_exists('edd_catalog_plugin_updater')) {
 ...
 $css .= '.entry-content a.cbp-l-caption-buttonLeft.buy, .entry-content a.cbp-s-caption-buttonLeft.buy, .entry-content a.cbp-m-caption-buttonLeft.buy, .entry-content a.cbp-l-caption-buttonRight {'; if ( $ab_catalog['katalog_button_color'] !== '') { $css .= 'background-color:'. $ab_catalog['katalog_button_color'] .';';} else { $css .= 'background-color:transparent;';} if ( $ab_catalog['katalog_button_text_color'] !== '') { $css .= 'color:'. $ab_catalog['katalog_button_text_color'] .';';} else { $css .= 'color:#000;';} $css .= '}
...
{'; if ( $ab_catalog['katalog_button_color_hover'] !== '') { $css .= 'background-color:'. $ab_catalog['katalog_button_color_hover'] .';';} else { $css .= 'background-color:transparent;';} $css .= '}
...
h3.entry-title3{text-align: '. $homepage['hp_header_align3'].';}
...
$css .= 'top:0;z-index:101;opacity:1;position: absolute;margin-left: auto;margin-right: auto;left: 0;right: 0;display: table;margin-top: '. $sub_slides['margin_block_top'].'px;margin-top: '. $sub_slides['margin_block_bottom'].'px;}
...
-moz-animation: '.  $sub_slides['slide_alimation'].' 1s ease-in-out  0.8s backwards;-webkit-animation: '.  $sub_slides['slide_alimation'].' 1s ease-in-out 0.8s backwards;animation: '.  $sub_slides['slide_alimation'].' 1s ease-in-out 0.8s backwards;'; } $css .= 'margin:0px;}'; if ($sub_slides['slide_position'] == 'center')  { 
	
	$css .= '#slides .caption1{-moz-animation: fadeIn 1s ease-in-out  0.3s backwards;-webkit-animation: fadeIn 1s ease-in-out 0.3s backwards;animation: fadeIn 1s ease-in-out 0.3s backwards; animation-delay: 0.5s;}
...
h1, .woocommerce h1, .wpcw-course-desc h1 {font-size:'. of_get_option('heading1').'}h2, .woocommerce h2, .wpcw-course-desc h2{font-size:'. of_get_option('heading2').'}h3, .woocommerce h3, .wpcw-course-desc h3{font-size:'. of_get_option('heading3').'}h4, .woocommerce h4, .wpcw-course-desc h4{font-size:'. of_get_option('heading4').'}h5, .woocommerce h5, .wpcw-course-desc h5{font-size:'. of_get_option('heading5').'}h6, .woocommerce h6, .wpcw-course-desc h6{font-size:'. of_get_option('heading6').'}
...
.woocommerce p.stars a {';if ( $ab_woocommerce['rating_color'] !== '') { $css .= 'color:'. $ab_woocommerce['rating_color'].';';} else { $css .= 'color:#000;';} $css .= '} 

.ab-inspiration-woocommerce-entry ul.products li.product .star-rating {';if ( $ab_woocommerce['rating_color'] !== '') { $css .= 'color:'. $ab_woocommerce['rating_color'].';';} else { $css .= 'color:#000;';} $css .= ' margin-left:auto; margin-right:auto} 
...
'; if ( of_get_option('color_one') !== '') { $css .= 'background-color:'. $color_one_rgbaul_scroll .'!important;';} else { $css .= 'background-color:transparent!important;';} $css .= '}
 .scrollupinsight:hover {
'; if ( of_get_option('color_one') !== '') { $css .= 'background-color:'. $color_one_rgbaul_scroll_h .'!important;';} else { $css .= 'background-color:transparent!important;';} $css .= '}
...
.widget-area a:link, .widget-area a:visited, div.post-font a:link, div.post-font a:visited,#content .post a:link,#content a:link, #content a:visited{'; if ( of_get_option('color_one') !== '') { $css .= 'color:'. shadesubs(''. of_get_option('color_one').'') .';';} else { $css .= 'color:#000;';} $css .= '}
...
'; if ( of_get_option('color_one') !== '') { if (of_get_option('color_one_text') == '1') { $css .= 'color:'. shadeone(''.of_get_option('color_one').'') .' ';} else {$css .= 'color:'. tintone(''.of_get_option('color_one').'') .' ';} } else { $css .= 'color:#000;';}  $css .= '}
...
.sub-form-top .input-form {'; if ( of_get_option('buttons_shape') == '3px'){ $css .= 'border-radius: 3px; -moz-border-radius: 3px;-webkit-border-radius: 3px;';} elseif ( of_get_option('buttons_shape') == '50px') {$css .= 'border-radius: 3px; -moz-border-radius: 3px;-webkit-border-radius: 3px;';} else {$css .= 'border-radius: 0px; -moz-border-radius: 0px;-webkit-border-radius: 0px;';}  $css .= '}
...
'; if ( of_get_option('color_two') !== '') { if (of_get_option('color_two_text') == '1') { $css .= 'color:'. shadeone(''.of_get_option('color_two').'') .'; ';} else {$css .= 'color:'. tintone(''.of_get_option('color_two').'') .'; ';}} else { $css .= 'color:#000;';} $css .= '}
...
'; if ( of_get_option('color_two') !== '') { $css .= 'background-color:'. of_get_option('color_two').';';} else { $css .= 'background-color:transparent;';} $css .= '}
...
'; if ( of_get_option('color_one') !== '') { $css .= 'text-decoration:underline; color:'. shadesubs(tonesubs(''. of_get_option('color_one')) .'') .';';} else { $css .= 'color:#000;';} $css .= '}
...
'; if ( of_get_option('color_tree') !== '') { $css .= 'color:'. of_get_option('color_tree').';';} else { $css .= 'color:#000;';} $css .= '} 
