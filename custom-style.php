...
.cbp-l-caption-buttonLeft:hover, .cbp-m-caption-buttonLeft:hover, .cbp-s-caption-buttonLeft:hover, div.post-font a.more-link:hover, .search-button:hover, .submit:hover, a.comment-reply-link:hover, #submit:hover, .submit:hover, .button-form:hover, #content div.post-font a.more-link:hover, .pagenavi a:hover, .pagenavi span.current:hover,#searchsubmit:hover, #content .woocommerce a.button:hover, .woocommerce a.button:hover,  #content .woocommerce button.button:hover,  #content .woocommerce input.button:hover, .buton-unit:hover, .scrollupinsight:hover, #content .wpcw_fe_quiz_submit_data input.fe_btn_completion:hover, #content .wpcw-course-enrollment-button a.fe_btn_completion:hover, .wpcw-button.wpcw-button-primary:hover, .tml-button:hover{ '; if ( of_get_option('button_color_hover') !== '') { $css .= 'background-color:'. of_get_option('button_color_hover').' !important;';} else { $css .= 'background-color:transparent !important;';} 
...
button.btnhov, input.btnhov, div.btnhov,  div.buttonpostform:hover, .sp-form .sp-button.buttonpostform:hover, button.buttonpostform:hover, .scrollupinsight:hover,    .pagenavi a:hover,input.button:hover, #access ul ul li,button.button,
