...
<div id="container-full" class="one-full-common one-column  container wp-courseware-calogue">
    ...
    background-size: cover;"> </div>
                    ...
                    <?php if(isset($ab_wpcourseware['checkbox_example'])) {  } else { ?> <div style="clear:both;"></div> <?php } ?>
                    <?php if(isset($ab_wpcourseware['checkbox_example'])) { ?> <div class="desc-course" itemprop="description"><?php the_excerpt(); ?></div><?php } else { ?> <div class="desc-course" itemprop="description"><?php the_excerpt(); ?></div><?php } ?>
                    <?php if(isset($ab_wpcourseware['checkbox_example'])) {  } else { ?> <div style="clear:both;"></div> <?php } ?>
                    ...
                    if ( $course->can_user_access( get_current_user_id() ) ) { ?>
                        ...
                        <?php $fe = new WPCW_UnitFrontend( $post );
                            ...
                            <a href="<?php echo the_permalink(); ?> " title="<?php echo the_permalink(); ?>" rel="bookmark" class="more-link open-course"><?php _e( 'Открыть курс', 'inspiration' ); ?>
                    </a>
                </div>
                <?php } 
