<?php
class EDD_INSPIRATION_Theme_Updater {
	...
	function update_nag() {
		...
		$update_onclick = ' onclick="if ( confirm(\'' . esc_js( __( "Если вы делали изменения в коде шаблона, при обновлении они будут потеряны. 'Отмена' чтобы остановить обновление, 'OK' обновить." ) ) . '\') ) {return true;}return false;"';
