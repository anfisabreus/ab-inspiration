...
if ( !function_exists( 'optionsframework_add_page' ) ) {
	...
	function optionsframework_add_page() {
		$of_page = add_theme_page( __('Настройки шаблона', 'inspiration'), __('Настройки шаблона', 'inspiration'), 'edit_theme_options', 'options-framework','optionsframework_page' );
  ...
  wp_enqueue_script( 'jquery' );
	...
	if ( !wp_script_is( 'wp-color-picker', 'registered' ) ) {
		...
		$colorpicker_l10n = array(
			'clear' => __( 'Очистить','inspiration' ),
			'defaultString' => __( 'По-умолчанию', 'inspiration' ),
			'pick' => __( 'Выбрать цвет', 'inspiration' )
		);
	...
	wp_enqueue_script( 'jquery-cookie', OPTIONS_FRAMEWORK_DIRECTORY . 'js/jquery.cookie.js'  );
	wp_enqueue_script( 'modernizr', OPTIONS_FRAMEWORK_DIRECTORY . 'js/modernizr.js'  );
   ...
   <div style="float:left; width:19%; border-left:1px solid #ccc; background:#F7F7F7; margin-top:10px; height:100%; position:relative">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <?php echo optionsframework_tabs(); ?>
    						...
    						<div style="clear:both; padding-top:20px; padding-left:0px; border-bottom:1px solid #ccc; width:100%"><div style="text-align:left; font-size:14px;padding-bottom:10px; padding-left:6px;"><strong><?php _e( 'Предпросмотр шрифтов:', 'inspiration' ); ?></strong></div>
    						...
    						<!-- <div style="width:200px; padding-bottom:10px;padding-left:6px;"><div id="showFonts" style="float:left; padding-right:5px;">Показать&nbsp;&nbsp; </div>  <div id="hideFonts" style="padding-right:5px;">| &nbsp;&nbsp; Скрыть</div></div> -->
    						
    <div>	
    
   <ul class="menu">
   			<li style="font-family:Arial; font-size:16px; padding-left:20px;">Arial
   			
   			<!-- <ul class="test">
      <li style="font-family:Arial; font-size:16px;" class="font-example1">
АБВГДЕЁЖЗИКЛМНО<br>
ПРСТУФХЦЧЪЫЬЭЮЯ<br><br>
абвгдеёжзиклмнопр<br>
стуфхцчъыьэюя<br><br>
0123456789
      </li>
   ...
   <li style="font-family:Verdana, Geneva; font-size:16px; padding-left:20px;">Verdana</li>
   <li style="font-family:Helvetica; font-size:16px; padding-left:20px;">Helvetica</li>
   <li style="font-family:Tahoma, Geneva; font-size:16px; padding-left:20px;">Tahoma</li>
   <li style="font-family:'Lucida Console'; font-size:16px; padding-left:20px;">Lucida Console</li>
   <li style="font-family:'Open Sans', Arial; font-size:16px; padding-left:20px;">Open Sans</li>
   <li style="font-family:'Open Sans Condensed'; font-size:16px; padding-left:20px;">Open Sans Condensed</li>
    <li style="font-family:'PT Sans Narrow'; font-size:16px; padding-left:20px;">PT Sans Narrow</li>
   <li style="font-family:Trebuchet; font-size:16px; padding-left:20px;">Trebuchet</li>
   <li style="font-family:Georgia; font-size:16px; padding-left:20px;">Georgia</li>
   <li style="font-family:Times New Roman; font-size:16px; padding-left:20px;">Times New Roman</li>
   <li style="font-family:Palatino; font-size:16px; padding-left:20px;">Palatino</li>
   <li style="font-family:'Comic Sans MS', cursive; font-size:16px; padding-left:20px;">Comic Sans MS</li>
   <li style="font-family:'Courier New'; font-size:16px; padding-left:20px;">Courier New</li>
   <li style="font-family:Impact; font-size:16px; padding-left:20px;">Impact</li>
   <li style="font-family:Marck Script; font-size:16px; padding-left:20px;">Marck Script</li>
   <li style="font-family:Neucha; font-size:16px; padding-left:20px;">Neucha </li>
   <li style="font-family:Poiret One; font-size:16px; padding-left:20px;">Poiret One</li>
   <li style="font-family:Lobster; font-size:16px; padding-left:20px;">Lobster</li>
   ...
   <li style="font-family:Roboto; font-size:18px; padding-left:20px;">Roboto</li>
    ...
    <div id="optionsframework-metabox" class="metabox-holder" style="width:80%;float:left">
	    <div id="optionsframework" class="postbox">
			...
			<div id="optionsframework-submit">
				<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Сохранить изменения', 'inspiration' ); ?>" />
				<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Сбросить настройки', 'inspiration' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Кликните OK, чтобы сбросить настройки и вернуться к настройкам по умолчанию. Все настройки, которые вы делали до этого, будут удалены!', 'inspiration' ) ); ?>' );" />
				<div class="clear"></div>
			</div>
			</form>
...
<?php
	...
	else { echo '<div style="font-size:18px; padding:20px; line-height:30px;">Для отображения раздела "Настройки шаблона" установите <strong>ключ обновления</strong> в разделе: <br> "Внешний вид" => "Ключ обновления" <br><br>Для приобретения ключа  перейдите по ссылке <a href="https://wpplaza.ru/shop/klyuch-avtoobnovleniya-shablona/">Ключ обновления</a></div>';}
}
endif;
...
function optionsframework_validate( $input ) {
	...
	if ( isset( $_POST['reset'] ) ) {
		add_settings_error( 'options-framework', 'restore_defaults', __( 'Настройки по умолчанию установлены.', 'inspiration' ), 'updated fade' );
...
function optionsframework_save_options_notice() {
	add_settings_error( 'options-framework', 'save_options', __( 'Настройки сохранены.', 'inspiration' ), 'updated fade' );
}
...
function optionsframework_adminbar() {
	...
	$wp_admin_bar->add_menu( array(
			'parent' => 'appearance',
			'id' => 'of_theme_options',
			'title' => __( 'Настройки шаблона', 'inspiration' ),
