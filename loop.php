...
<div class="post-font">
<p><?php _e( 'Извините, но по Вашему запросу ничего не найдено. Воспользуйтесь формой поиска, чтобы найти то, что Вы ищите.', 'inspiration' ); ?></p>
<?php get_search_form(); ?>
</div>
</div><!-- .entry-content -->
</div><!-- #post-0 -->
...
<h2 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( '%s', 'inspiration' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
<div class="entry-content">
...
$total_images ); ?></em></p>
<?php the_excerpt(); ?><?php endif; ?></div><!-- .entry-content -->
<div class="entry-utility">
<a href="<?php echo get_term_link( _x('gallery', 'gallery category slug', 'inspiration'), 'category' ); ?>" title="<?php esc_attr_e( 'Посмотреть записи в категории Галерея', 'inspiration' ); ?>"><?php _e( 'Еще галереи', 'inspiration' ); ?></a>
<span class="meta-sep">|</span>
<span class="comments-link"><?php comments_popup_link( __( 'Оставить комментарий', 'inspiration' ), __( '1 комментарий', 'inspiration' ), __( '% комментариев', 'inspiration' ) ); ?></span>
